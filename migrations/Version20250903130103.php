 ...
 */
final class Version20250903130103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE modelload (id INT AUTO_INCREMENT NOT NULL, model_id INT NOT NULL, loaditem_id INT NOT NULL, INDEX IDX_3DAE97187975B7E7 (model_id), INDEX IDX_3DAE9718811F5C68 (loaditem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
