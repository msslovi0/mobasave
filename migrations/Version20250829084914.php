 ...
 */
final class Version20250829084914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mbs_digital_function (id INT AUTO_INCREMENT NOT NULL, digital_id INT NOT NULL, INDEX IDX_E023412BD3571EA4 (digital_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
