 ...
 */
final class Version20250829094228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mbs_model_load (id INT AUTO_INCREMENT NOT NULL, loaditem_id INT DEFAULT NULL, INDEX IDX_D77A33CA811F5C68 (loaditem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mbs_model_loaditem (model_load_id INT NOT NULL, model_id INT NOT NULL, INDEX IDX_EDA1A6BEC15D0F1A (model_load_id), INDEX IDX_EDA1A6BE7975B7E7 (model_id), PRIMARY KEY(model_load_id, model_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
