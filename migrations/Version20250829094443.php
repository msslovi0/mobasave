 ...
 */
final class Version20250829094443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE model_loaditem (id INT AUTO_INCREMENT NOT NULL, model_id INT DEFAULT NULL, loaditem_id INT DEFAULT NULL, INDEX IDX_C407F0027975B7E7 (model_id), INDEX IDX_C407F002811F5C68 (loaditem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
